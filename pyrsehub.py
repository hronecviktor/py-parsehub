...
class phProject(object):
        def __init__(self, ph, arg_dict: dict):
            ...
            if 'last_run' not in arg_dict.keys():
                self.last_run = None
